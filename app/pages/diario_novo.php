...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form class="validate" action="acao/diario_oficialAdicionar.php" method="post">
          <div class="form-group-attached">
                ...
                <div class="form-group form-group-default required">
                  ...
                  <select class="form-control" id="Categoria" name="Categoria">
                      ...
                      foreach ($lCategoria as $vCategoria) {
                          ?>
                          <option value="<?php echo $vCategoria->id; ?>" ><?php echo $vCategoria->Nome; ?></option>
                          <?php
                      }
                      ?>
                  </select>
            ...
            <div class="col-sm-12">
              <div class="form-group form-group-default required">
                <label>Titulo</label>
                <input required="required" id="txtTitulo" name="txtTitulo" required="required" class="form-control" type="text" placeholder="EXTRATO DE CONTRATO Nº.052-2017">
              </div>
            </div>
          </div>
            ...
            <div class="row clearfix">
              <div class="col-sm-12">
                <div class="form-group form-group-default required" aria-required="true">
                  <textarea class="form-control" required="required" name="texto" id="texto" aria-invalid="false"></textarea>
                  <script>
            ...
            <div class="row clearfix">
              <div class="col-sm-6">
                <div class="form-group form-group-default">
                  ...
                  <input required="required" id="txtTitulo" name="txtTitulo" disabled required="required" class="form-control" type="text" value="<?php echo $diahoje;?> DE <?php echo retorna_mes_extenso($meshoje);?> DE <?php echo $anohoje;?>">
                  </select>
                </div>
              </div>
              <div class="col-sm-6">
