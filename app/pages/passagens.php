...
function vizualizar(id){
    ...
    $("#conteudoModal").load('pages/passagensDetalhe.php?id=' + id);
}
...
function novo(id){
    ...
    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/passagensNovo.php');
}
</script>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLargeLabel">PASSAGENS</h4>
            </div>
...
<div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
  ...
  $Atual=$pdo->prepare("SELECT * FROM passagens WHERE CdPrefeitura = '".$vAdmin->CdPrefeitura."' AND  Acao = 'Publicado' ORDER BY ano DESC, mes DESC");
  $Atual->execute();
...
if($ContaMes == 2){
  ...
  $sql="SELECT * FROM passagens WHERE CdPrefeitura = '".$vAdmin->CdPrefeitura."' AND  Acao = 'Publicado' AND mes = '".$mesSeleciona."' AND ano = '".$anoSeleciona."' ORDER BY mes DESC, ano DESC";
  ...
  <div class="panel panel-default">
    <div class="grid-title no-border">
        <h4>Passagens de <strong><?php echo retorna_mes_extenso($mesSeleciona);?> <?php echo $anoSeleciona;?></strong></h4>
    </div>
          ...
          <table class="table table-full">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo number_format($ler->valor, 2, ',', '.');?></td>
                <td class="text-right">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="panel-group" id="accordion1">
                              <?php
                              $Ano=$pdo->prepare("SELECT * FROM passagens WHERE CdPrefeitura = '".$vAdmin->CdPrefeitura."' AND  Acao = 'Publicado' GROUP BY ano ORDER BY ano DESC");
                              $Ano->execute();
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse<?php echo $vAno->ano;?>" class="panel-collapse collapse" style="height: 0px;">
                                        <div class="panel-body">
                                          <ul>
                                            <?php
                                            $Mes=$pdo->prepare("SELECT * FROM passagens WHERE CdPrefeitura = '".$vAdmin->CdPrefeitura."' AND Acao = 'Publicado' AND ano = '".$vAno->ano."' GROUP BY mes ORDER BY mes ASC");
                                            $Mes->execute();
