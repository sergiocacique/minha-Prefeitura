...
function vizualizar(id){
    ...
    $("#conteudoModal").load('pages/despesasDetalhe.php?id=' + id);
}
function novo(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/despesasNovo.php');
}
  ...
  <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
    <div class="inner">
      ...
      <ul class="breadcrumb">
        ...
        <li>Transparência</li>
        <li><a href="#" class="active">Despesas</a>
        </li>
      </ul>
      <!-- END BREADCRUMB -->
    </div>
...
if($ContaMes == 2){
  ...
  <div class="panel panel-default">
    <div class="grid-title no-border">
        <h4>Despesas de <strong><?php echo retorna_mes_extenso($mesSeleciona);?> <?php echo $anoSeleciona;?></strong></h4>
    </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <p> você tem <strong><?php echo $tCaixa;?></strong> despesa(s) na sua caixa de tarefas <a href="?p=minha_tarefa&t=despesas" class="alert-link">ir para caixa de tarefa</a>.</p>
</div>
</div>
<?php }?>
  <div class="panel panel-default">
