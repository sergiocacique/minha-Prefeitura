...
function vizualizar(id){
    ...
    $("#conteudoModal").load('pages/relatorio_gestaoDetalhe.php?id=' + id);
}
function novo(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/relatorio_gestaoNovo.php');
}
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <p> você tem <strong><?php echo $tCaixa;?></strong> relátorio(s) de gestão na sua caixa de tarefas <a href="?p=minha_tarefa&t=relatorio_gestao" class="alert-link">ir para caixa de tarefa</a>.</p>
</div>
</div>
<?php }?>
  <div class="panel panel-default">
