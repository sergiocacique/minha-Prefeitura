...
function vizualizar(id){
    ...
    $("#conteudoModal").load('pages/projetos_sociaisDetalhe.php?id=' + id);
}
function novo(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/projetos_sociaisNovo.php');
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLargeLabel">PROJETOS SOCIAIS</h4>
            </div>
  ...
  <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
    <div class="inner">
      ...
      <ul class="breadcrumb">
        ...
        <li>Transparência</li>
        <li><a href="#" class="active">Projetos Sociais</a>
        </li>
      </ul>
      <!-- END BREADCRUMB -->
    </div>
...
<div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
  ...
  $Atual=$pdo->prepare("SELECT * FROM projetos_sociais WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND Acao = 'Publicado' ORDER BY ano DESC, mes DESC");
  $Atual->execute();
...
if($ContaMes == 2){
  ...
  $sql="SELECT * FROM projetos_sociais WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND Acao = 'Publicado' AND mes = '".$mesSeleciona."' AND ano = '".$anoSeleciona."' ORDER BY mes DESC, ano DESC";
  ...
  <div class="panel panel-default">
    <div class="grid-title no-border">
        <h4>Projetos Sociais de <strong><?php echo retorna_mes_extenso($mesSeleciona);?> <?php echo $anoSeleciona;?></strong></h4>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-full">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $ler->servico;?></td>
                <td><?php echo $ler->publico;?></td>
...
<div class="summary col-md-3 col-sm-3 col-md-pull-9 col-sm-pull-9">
  <?php
  $Caixa=$pdo->prepare("SELECT * FROM projetos_sociais WHERE CdPrefeitura = '".$vAdmin->CdPrefeitura."' AND Acao IN('Arquivo','Correcao','Cadastrando')");
  $Caixa->execute();
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
  <p> você tem <strong><?php echo $tCaixa;?></strong> convênio(s) na sua caixa de tarefas <a href="?p=minha_tarefa&t=projetos_sociais" class="alert-link">ir para caixa de tarefa</a>.</p>
</div>
</div>
<?php }?>
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <div class="panel-group" id="accordion1">
                              <?php
                              $Ano=$pdo->prepare("SELECT * FROM projetos_sociais WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND Acao = 'Publicado' GROUP BY ano ORDER BY ano DESC");
                              $Ano->execute();
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapse<?php echo $vAno->ano;?>" class="panel-collapse collapse" style="height: 0px;">
                                        <div class="panel-body">
                                          <ul>
                                            <?php
                                            $Mes=$pdo->prepare("SELECT * FROM projetos_sociais WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND Acao = 'Publicado' AND ano = '".$vAno->ano."' GROUP BY mes ORDER BY mes ASC");
                                            $Mes->execute();
                                            ...
                                            foreach ($lMes as $vMes) {
                                              ...
                                              if($total == 2){
                                                ...
                                                ?>
                                                <li>
                                                  <a href="?p=projetos_sociais&m=<?php echo $mesSel;?>&a=<?php echo $vMes->ano;?>"><?php echo retorna_mes_extenso($vMes->mes);?></a>
                                                </li>
                                                <?php
                                            }
                                            ?>
