        ...
        <div class=" pull-left sm-table">
          <div class="header-inner">
            <div class="brand inline">
              <img src="../dinamico/brasao/<?php echo $vAdmin->Brasao?>" alt="<?php echo $vAdmin->Fantasia?>" data-src="../dinamico/brasao/<?php echo $vAdmin->Brasao?>" data-src-retina="../dinamico/brasao/<?php echo $vAdmin->Brasao?>" width="50">
            </div>
