...
function vizualizar(id){
    ...
    $("#conteudoModal").load('tarefa/rreoDetalhe.php?id=' + id);
}
function editar(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/rreoEditar.php?id=' + id);
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLargeLabel">RREO</h4>
            </div>
...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    if(isset($_GET['m']) && isset($_GET['a'])){
      ...
      $sql = "SELECT * FROM rreo WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY ano DESC, mes DESC";
    ...
    $sql="SELECT * FROM rreo WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY mes DESC, ano DESC";
