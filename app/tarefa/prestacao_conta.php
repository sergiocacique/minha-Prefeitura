...
function vizualizar(id){
    ...
    $("#conteudoModal").load('tarefa/prestacao_contaDetalhe.php?id=' + id);
}
function editar(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/prestacao_contaEditar.php?id=' + id);
}
...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    if(isset($_GET['m']) && isset($_GET['a'])){
      ...
      $sql = "SELECT * FROM prestacao_conta WHERE Pasta = 'prestacao' AND CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY ano DESC, mes DESC";
    ...
    $sql="SELECT * FROM prestacao_conta WHERE Pasta = 'prestacao' AND CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY mes DESC, ano DESC";
    ...
    <div class="panel panel-default">
      <div class="grid-title no-border">
          <h4>Prestação de Contas</strong></h4>
      </div>
