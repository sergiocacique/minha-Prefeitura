...
$Atual=$pdo->prepare("SELECT * FROM rreo WHERE id = '".$id."'");
$Atual->execute();
  ...
  <div class="panel-body  text-left">
      ...
      <div class="col-md-12 ocultar">
        <table class="table">
            ...
            <tr>
                <td>Bimestre / Ano</td>
                <td><?php echo ($rsLinha->Bimestre);?> / <?php echo $rsLinha->Ano;?></td>
            </tr>

            <?php
            $dir = '../dinamico/municipio/'.$vAdmin->Pasta.'/'.$rsLinha->Ano.'/rreo/'.$rsLinha->Arquivo;
             ?>
            <tr class="fundoTable">
                <td colspan="2">
          ...
          <div class="callout callout-success callout-left fade in">
              ...
              <small>publicado em: <?php echo date('d/m/Y h:m:s', strtotime($rsLinha->DtAtualizado));?></small><br />
...
<a href="./acao/rreoStatus.php?id=<?php echo $rsLinha->id;?>&a=aprovar" class="btn btn-green">Aprovar</a>
<?php }else{?>
<a href="./acao/rreoStatus.php?id=<?php echo $rsLinha->id;?>&a=tramitar" class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a href="./acao/rreoStatus.php?id=<?php echo $rsLinha->id;?>&a=excluir" class="btn btn-red">Excluir</a>
