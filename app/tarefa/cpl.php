...
function vizualizar(id){
    ...
    $("#conteudoModal").load('tarefa/cplDetalhe.php?id=' + id);
}
function editar(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/cplEditar.php?id=' + id);
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-lg">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLargeLabel">CONTRATO E LICITAÇÃO</h4>
            </div>
...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    if(isset($_GET['m']) && isset($_GET['a'])){
      ...
      $sql = "SELECT * FROM cpl WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY DATE_FORMAT(DtAbertura, '%Y') DESC, DATE_FORMAT(DtAbertura, '%m') DESC";
    ...
    <div class="panel panel-default">
      <div class="grid-title no-border">
          <h4>Contratos e Licitações</strong></h4>
      </div>
