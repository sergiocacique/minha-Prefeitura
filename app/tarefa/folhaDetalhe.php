...
<a href="./acao/folhaStatus.php?Protocolo=<?php echo $rsLinha->Protocolo;?>&a=aprovar" class="btn btn-green">Aprovar</a>
<?php }else{?>
<a href="./acao/folhaStatus.php?Protocolo=<?php echo $rsLinha->Protocolo;?>&a=tramitar" class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a href="./acao/folhaStatus.php?Protocolo=<?php echo $rsLinha->Protocolo;?>&a=excluir" class="btn btn-red">Excluir</a>
