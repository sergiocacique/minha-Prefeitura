...
<a href="./acao/cplStatus.php?id=<?php echo $rsLinha->CdCPL;?>&a=aprovar" class="btn btn-green">Aprovar</a>
<?php }else{?>
<a href="./acao/cplStatus.php?id=<?php echo $rsLinha->CdCPL;?>&a=tramitar" class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a href="./acao/cplStatus.php?id=<?php echo $rsLinha->CdCPL;?>&a=excluir" class="btn btn-red">Excluir</a>
