...
<a class="btn btn-green">Aprovar</a>
<?php }else{?>
<a class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a class="btn btn-red">Excluir</a>
<button type="button" class="btn btn-amber" onclick="editar(<?php echo $rsLinha->id; ?>)">Alterar</button>
