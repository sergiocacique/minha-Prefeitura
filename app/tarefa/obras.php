...
function vizualizar(id){
    ...
    $("#conteudoModal").load('tarefa/obrasDetalhe.php?id=' + id);
}
function editar(id){

    //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
    $('#modalRecusar').modal('show');
    $("#conteudoModal").load('pages/obrasEditar.php?id=' + id);
}
...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    if(isset($_GET['m']) && isset($_GET['a'])){
      ...
      $sql = "SELECT * FROM obras WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY ano DESC, mes DESC";
    ...
    $sql="SELECT * FROM obras WHERE CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY mes DESC, ano DESC";
