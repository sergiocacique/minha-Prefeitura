...
<div class="container-fluid container-fixed-lg">
  ...
  <div class="col-md-9 col-sm-9 col-md-push-3 col-sm-push-3">
    ...
    if(isset($_GET['m']) && isset($_GET['a'])){
      ...
      $sql = "SELECT * FROM prestacao_conta WHERE Pasta = 'rgf' AND CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY ano DESC, mes DESC";
    ...
    $sql="SELECT * FROM prestacao_conta WHERE Pasta = 'rgf' AND CdPrefeitura = '". $vAdmin->CdPrefeitura ."' AND $UsuarioLog1 ORDER BY mes DESC, ano DESC";
