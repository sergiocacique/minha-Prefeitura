  ...
  <div class="panel-body  text-left">
      ...
      <div class="col-md-12 ocultar">
        <table class="table">
            ...
            <?php
            $dir = '../dinamico/municipio/'.$vAdmin->Pasta.'/'.$rsLinha->Ano.'/prestacao_conta/'.$rsLinha->Arquivo;
             ?>
            <tr class="fundoTable">
                <td colspan="2">
...
<a href="./acao/prestacao_contaStatus.php?id=<?php echo $rsLinha->id;?>&a=aprovar" class="btn btn-green">Aprovar</a>
<?php }else{?>
<a href="./acao/prestacao_contaStatus.php?id=<?php echo $rsLinha->id;?>&a=tramitar" class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a href="./acao/prestacao_contaStatus.php?id=<?php echo $rsLinha->id;?>&a=excluir" class="btn btn-red">Excluir</a>
