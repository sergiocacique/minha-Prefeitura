...
<a href="./acao/fundebStatus.php?id=<?php echo $rsLinha->id;?>&a=aprovar" class="btn btn-green">Aprovar</a>
<?php }else{?>
<a href="./acao/fundebStatus.php?id=<?php echo $rsLinha->id;?>&a=tramitar" class="btn btn-green">Enviar para o orgão fiscalizador</a>
<?php }?>
<a href="./acao/fundebStatus.php?id=<?php echo $rsLinha->id;?>&a=excluir" class="btn btn-red">Excluir</a>
