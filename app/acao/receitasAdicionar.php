...
if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $nome_final)) {
    ...
    $buscasegura=$pdo->prepare("INSERT INTO receitas(CdPrefeitura,CdUsuario,Titulo,Mes,Ano,Arquivo,Acao,DtCadastro,Categoria)VALUES(:CdPrefeitura,:CdUsuario,:Titulo,:Mes,:Ano,:Arquivo,:Acao,:DtCadastro,:Categoria)");
...
<script language= "JavaScript">
    location.href="../index.php?p=receitas"
</script>
